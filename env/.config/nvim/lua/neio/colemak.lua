...
local mappings = {
    ...
    -- PU/PD
    kmap({ n, x }, "j", "<PageUp>", "PageUp"),
    kmap({ n, x }, "h", "<PageDown>", "PageDown"),
    ...
    kmap({ n, x }, "F", "Z", ""),
    kmap({ n, x }, "FF", "zz", ""),
    kmap({ n, x }, "bb", "zz", "Scroll line and cursor to center"),
    kmap({ n, x }, "bz", "zb", "Scroll line and cursor to bottom"),
    kmap({ n, x }, "bi", "zk", "Move up to fold"),
    ...
    -- insert/append
    kmap({ n }, "s", "i", "Insert Right"),
    kmap({ n }, "S", "I", "Insert at beginning of line"),
    kmap({ n }, "t", "a", "Insert Left"),
    kmap({ n }, "T", "A", "Right"),
